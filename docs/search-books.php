...
>>>>>>> 5ab69aa5475e9f79cc66573599e871513a096819:docs/search-books.php
...
>>>>>>> 5ab69aa5475e9f79cc66573599e871513a096819:docs/search-books.php
                                  <div class="form-group">
                                      ...
                                      <small id="emailHelp1" class="form-text text-muted">This is the field that gets the most accurate results.</small>
                                  </div>

                                  <div class="form-group">
                                      <label for="author">Author name</label>
                                      <input type="text" class="form-control" id="author" aria-describedby="emailHelp" placeholder="Enter author name">
                                      <small id="emailHelp2" class="form-text text-muted">Narrow down your search by using this field.</small>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <small id="emailHelp3" class="form-text text-muted">This is for the dedicated ones who know right down till the code.</small>
                                  </div>


<<<<<<< HEAD:docs/search-books.html
                                  <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4" onclick="searchBook()">Search</button>
                              </form>
=======
